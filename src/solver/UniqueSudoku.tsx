...
function _generateUniqueSudoku(
  ...
  if (currentDifficulty === 'Easy') {
    minimumCells = 3
    maximumCells = 7
    totalCells = totalCellsP || 45
  } else if (currentDifficulty === 'Medium') {
    minimumCells = 2
    maximumCells = 6
    totalCells = totalCellsP || 40
  } else {
    minimumCells = 1
    maximumCells = 5
    totalCells = totalCellsP || 30
  }
...
export const getUniqueSudoku = (difficulty: string, totalCells?: number, e?: React.ChangeEvent<HTMLSelectElement>) => {
  ...
  temporaryInitArray = _generateUniqueSudoku(temporarySolvedArray, difficulty, totalCells, e)
