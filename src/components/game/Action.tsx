...
const Svg = (props: SvgProps) => {
  if (props.action === 'undo') {
    return (
      <ActionIcon height="512pt" viewBox="0 0 512 512" width="512pt" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    return (
      <ActionIcon version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.001 512.001">
        <path
    ...
    return (
      <ActionIcon version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 432.4 432.4">
        <path
...
export const Action = (props: ActionProps) => {
  return (
    <ActionWrapper className={props.action} onClick={props.onClickAction}>
      <Svg action={props.action} />
      <p className="text">{props.action === 'undo' ? 'Undo' : props.action === 'erase' ? 'Erase' : 'Hint'}</p>
    </ActionWrapper>
  )
}
